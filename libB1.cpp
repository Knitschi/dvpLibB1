...
namespace dvpLibB1_2_0_0
{
	...
	void b1UseValueType(dvpLibC_1_0_0::ValueType value)
	{
		std::cout << "Called dpvLibB1::b1UseValueType() with argument " << value.foo << value.bar << "\n";
	}

	dvpLibC_1_0_0::ValueType b1ReturnValueType()
	{
		return dvpLibC_1_0_0::ValueType{ 3, 4 };
	}

	void b1UseComplexType(dvpLibC_1_0_0::ComplexType* value)
	{
	...
	dvpLibC_1_0_0::ComplexType* b1ReturnComplexType()
	{
	...
	void b1SetComplexType(std::unique_ptr<dvpLibC_1_0_0::ComplexType> value)
	{
		globalComplexType = std::move(value);
	}

	std::unique_ptr<dvpLibC_1_0_0::ComplexType> b1CreateComplexType()
	{
